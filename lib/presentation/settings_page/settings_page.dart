        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              leading: Builder(builder: (context) {
                final value = context
                    .select((SettingsCubit cubit) => cubit.state.elevation);

                return Radio<ElevationUnit>(
                  value: ElevationUnit.m,
                  groupValue: value,
                  onChanged: (value) {
                    if (value != null) {
                      context.read<SettingsCubit>().updateElevationUnit(value);
                    }
                  },
                );
              }),
